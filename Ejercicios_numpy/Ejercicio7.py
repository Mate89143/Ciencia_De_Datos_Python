...
# Usamos randint para generar IDs únicos de sensores (enteros del 1 al 100)
ids_sensores = np.random.randint(1, 101, size=100)
print("Mediciones de sensores (100 valores):")
print(np.round(mediciones, 2))
...
criticos = len(fuera_de_rango[0])

# Imprimir resultados
print(f"Sensores fuera del rango aceptable (20-80): {fuera_de_rango[0]}")
print(f"IDs de sensores críticos: {ids_sensores[fuera_de_rango[0]]}")
